            ...
            <div class="submenu-content notes">
              <ul>
                ...
                <li>
                  ...
                  <span class="note-details">Leverage agile frameworks to provide a robust synopsis for high level overviews. </span>
                </li>
                <li>
                  <i class="pi pi-circle-on important"></i>
                  <span class="note-header">EXECUTIVE INFLUENCER OUTREACH</span>
                  <span class="note-date">23.33 2/7/2018</span>
                  <span class="note-details">Bring to the table win-win survival strategies to ensure proactive domination. </span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="note-date">23.33 2/7/2018</span>
                  <span class="note-details">Podcasting operational change management inside of workflows to establish a framework. </span>
                </li>
                <li>
                  <i class="pi pi-circle-on work"></i>
                  <span class="note-header">INVESTIGATE FOLLOWER PROGRAMS</span>
                  <span class="note-date">23.33 2/7/2018</span>
                  <span class="note-details">Collaboratively administrate empowered markets via plug-and-play networks. </span>
                </li>
              </ul>
            </div>
          </p-tabPanel>
