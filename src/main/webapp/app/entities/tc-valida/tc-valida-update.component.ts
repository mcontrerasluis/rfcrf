...
export class TcValidaUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    moral: [null, [Validators.required, Validators.min(0), Validators.max(1)]],
    fisica: [null, [Validators.required, Validators.min(0), Validators.max(1)]],
